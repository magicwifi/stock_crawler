...
def getHtml():
    ...
    file = open('my_hk_all_news_url.csv', 'r')
    file_write = open('my_hk_all_news_article.csv', 'w')
    ...
    for line in lines:
        ...
        try:
            ...
            for paragraph in part:
                ...
                '''
            #print(article)
            file_line = title +"||"+url+"||"+label_property+"||"+code+"||"+company+"||"+article+"\n"
            file_write.write(file_line)
